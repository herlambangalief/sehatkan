...
include 'koneksi.php';
	...
	if (isset($_POST['running'])) {
		...
		$sql="INSERT INTO `kategori_artikel` (`id_kategori_artikel`, `nama_kategori_artikel`) VALUES (NULL, '$nama_artikel')";
      ...
      <form action="" method="post" enctype="multipart/form-data">
		<div class="box_general padding_bottom">
			<div class="header_box version_2">
				<h2>Tambah Data Kategori Artikel</h2>
			</div>
			<div class="row">
            ...
            <div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="nama_artikel" placeholder="Nama Kategori Artikel">
							</div>
						</div>
					</div>
					<!-- /row-->
