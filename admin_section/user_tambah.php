...
include 'koneksi.php';
    ...
    $tanggal=date('Y-m-d', strtotime($tanggal_lahir));
		...
		$sql="INSERT INTO `pasien` (`id_pasien`, `nama_pasien`, `alamat_pasien`, `tanggal_lahir`, `no_tlp`) VALUES (NULL, '$nama', '$alamat', '$tanggal', '$no_telepon')";
		...
		<div class="box_general padding_bottom">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="nama_pasien" placeholder="Nama Lengkap">
							</div>
						</div>
            <div class="col-md-4">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Alamat</label>
                <textarea rows="5" required class="form-control" name="alamat" placeholder="Alamat"></textarea>
              </div>
            </div>
          </div>
		</div>
