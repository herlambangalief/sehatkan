			...
			<div class="row">
				<div class="col-lg-12">
					<div class="bloglist singlepost">
						<p><img style="max-width:300px; height: auto;" class="img-fluid" src="../admin_section/img/<?php echo $fetch['foto_obat'] ?>"></p>
						<h1><?php echo $fetch['nama_obat']; ?></h1>
						<!-- /post meta -->
						<div class="post-content">
							...
							<h4>Golongan Obat</h4>
							<p><?php echo $fetch['golongan_obat']; ?></p>

							<h4>Kemasan Obat</h4>
							<p><?php echo $fetch['kemasan_obat']; ?></p>

							<h4>Produsen Obat</h4>
							<p><?php echo $fetch['produsen_obat']; ?></p>

							<h4>Manfaat Obat</h4>
							<p><?php echo $fetch['manfaat_obat']; ?></p>

							<h4>Komposisi Obat</h4>
							<p><?php echo $fetch['komposisi_obat']; ?></p>

							<h4>Dosis Obat</h4>
							<p><?php echo $fetch['dosis_obat']; ?></p>

							<h4>Aturan Pakai Obat</h4>
							<p><?php echo $fetch['aturan_pakai_obat']; ?></p>
						</div>
						<!-- /post -->
					</div>
					<!-- /single-post -->
